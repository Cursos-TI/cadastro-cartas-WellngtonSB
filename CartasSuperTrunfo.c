...
int main() {
  ...
  SuperPoder = Populacao + AreaKM + PIB + PontosTuristicos + PIBPercapita + inversoDensidade ;
  ...
  SuperPoder2 = Populacao2 + AreaKM2 + PIB2 + PontosTuristicos2 + PIBPercapita2 + inversoDensidade2; 
